...
public class IndexIVFFlatDedup extends IndexIVFFlat {
  ...
  public void setInstances(SWIGTYPE_p_std__unordered_multimapT_long_long_t value) {
    swigfaissJNI.IndexIVFFlatDedup_instances_set(
        swigCPtr, this, SWIGTYPE_p_std__unordered_multimapT_long_long_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__unordered_multimapT_long_long_t getInstances() {
    return new SWIGTYPE_p_std__unordered_multimapT_long_long_t(
        swigfaissJNI.IndexIVFFlatDedup_instances_get(swigCPtr, this), true);
  }

  public IndexIVFFlatDedup(Index quantizer, long d, long nlist_, MetricType arg3) {
    this(
        swigfaissJNI.new_IndexIVFFlatDedup__SWIG_0(
            Index.getCPtr(quantizer), quantizer, d, nlist_, arg3.swigValue()),
        true);
  }

  public IndexIVFFlatDedup(Index quantizer, long d, long nlist_) {
    this(
        swigfaissJNI.new_IndexIVFFlatDedup__SWIG_1(Index.getCPtr(quantizer), quantizer, d, nlist_),
        true);
  }
  ...
  public void add_with_ids(int n, SWIGTYPE_p_float x, SWIGTYPE_p_long xids) {
    swigfaissJNI.IndexIVFFlatDedup_add_with_ids(
  ...
  public void search_preassigned(
    ...
    swigfaissJNI.IndexIVFFlatDedup_search_preassigned__SWIG_0(
        swigCPtr,
        this,
        n,
  ...
  public void range_search(int n, SWIGTYPE_p_float x, float radius, RangeSearchResult result) {
    swigfaissJNI.IndexIVFFlatDedup_range_search(
        swigCPtr,
        this,
        n,
        SWIGTYPE_p_float.getCPtr(x),
  ...
  public void update_vectors(int nv, SWIGTYPE_p_long idx, SWIGTYPE_p_float v) {
    swigfaissJNI.IndexIVFFlatDedup_update_vectors(
        swigCPtr, this, nv, SWIGTYPE_p_long.getCPtr(idx), SWIGTYPE_p_float.getCPtr(v));
  }

  public void reconstruct_from_offset(int list_no, int offset, SWIGTYPE_p_float recons) {
    swigfaissJNI.IndexIVFFlatDedup_reconstruct_from_offset(
