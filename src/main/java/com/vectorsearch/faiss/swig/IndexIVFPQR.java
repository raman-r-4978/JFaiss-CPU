...
public class IndexIVFPQR extends IndexIVFPQ {
  ...
  public IndexIVFPQR(
      ...
      long nbits_per_idx,
      long M_refine,
      long nbits_per_idx_refine) {
    this(
        swigfaissJNI.new_IndexIVFPQR__SWIG_0(
  ...
  public void add_with_ids(int n, SWIGTYPE_p_float x, SWIGTYPE_p_long xids) {
    swigfaissJNI.IndexIVFPQR_add_with_ids(
  ...
  public void add_core(
    ...
    swigfaissJNI.IndexIVFPQR_add_core__SWIG_0(
        swigCPtr,
        this,
        n,
  ...
  public void add_core(int n, SWIGTYPE_p_float x, SWIGTYPE_p_long xids) {
    swigfaissJNI.IndexIVFPQR_add_core__SWIG_1(
        swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long.getCPtr(xids));
  }

  public void reconstruct_from_offset(int list_no, int offset, SWIGTYPE_p_float recons) {
    swigfaissJNI.IndexIVFPQR_reconstruct_from_offset(
  ...
  public void search_preassigned(
    ...
    swigfaissJNI.IndexIVFPQR_search_preassigned__SWIG_0(
        swigCPtr,
        this,
        n,
        SWIGTYPE_p_float.getCPtr(x),
  ...
  public void search_preassigned(
      ...
      SWIGTYPE_p_long labels,
      boolean store_pairs) {
    swigfaissJNI.IndexIVFPQR_search_preassigned__SWIG_1(
        swigCPtr,
        this,
        n,
        SWIGTYPE_p_float.getCPtr(x),
