...
public class int_minheap_array_t {
  ...
  public void addn_with_ids(
    ...
    swigfaissJNI.int_minheap_array_t_addn_with_ids__SWIG_0(
        swigCPtr,
        this,
        nj,
  ...
  public void addn_with_ids(long nj, SWIGTYPE_p_int vin, SWIGTYPE_p_long id_in, int id_stride) {
    swigfaissJNI.int_minheap_array_t_addn_with_ids__SWIG_2(
  ...
  public void addn_with_ids(long nj, SWIGTYPE_p_int vin) {
    swigfaissJNI.int_minheap_array_t_addn_with_ids__SWIG_4(
  ...
  public void per_line_extrema(SWIGTYPE_p_int vals_out, SWIGTYPE_p_long idx_out) {
    swigfaissJNI.int_minheap_array_t_per_line_extrema(
