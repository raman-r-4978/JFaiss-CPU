...
public class MultiIndexQuantizer2 extends MultiIndexQuantizer {
  ...
  public void setAssign_indexes(SWIGTYPE_p_std__vectorT_faiss__Index_p_t value) {
    swigfaissJNI.MultiIndexQuantizer2_assign_indexes_set(
  ...
  public MultiIndexQuantizer2(int d, long M, long nbits, SWIGTYPE_p_p_faiss__Index indexes) {
    this(
        swigfaissJNI.new_MultiIndexQuantizer2__SWIG_0(
            d, M, nbits, SWIGTYPE_p_p_faiss__Index.getCPtr(indexes)),
        true);
  }

  public MultiIndexQuantizer2(int d, long nbits, Index assign_index_0, Index assign_index_1) {
    this(
        swigfaissJNI.new_MultiIndexQuantizer2__SWIG_1(
            d,
            nbits,
            Index.getCPtr(assign_index_0),
            assign_index_0,
            Index.getCPtr(assign_index_1),
            assign_index_1),
        true);
  }
  ...
  public void search(
    ...
    swigfaissJNI.MultiIndexQuantizer2_search(
        swigCPtr,
        this,
        n,
