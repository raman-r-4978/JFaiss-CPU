...
public class ProductQuantizer {
  ...
  public void setCp(ClusteringParameters value) {
    swigfaissJNI.ProductQuantizer_cp_set(
        swigCPtr, this, ClusteringParameters.getCPtr(value), value);
  }
  ...
  public void set_params(SWIGTYPE_p_float centroids, int m) {
    swigfaissJNI.ProductQuantizer_set_params(
        swigCPtr, this, SWIGTYPE_p_float.getCPtr(centroids), m);
  }

  public void compute_code(SWIGTYPE_p_float x, SWIGTYPE_p_unsigned_char code) {
    swigfaissJNI.ProductQuantizer_compute_code(
  ...
  public void compute_codes(SWIGTYPE_p_float x, SWIGTYPE_p_unsigned_char codes, long n) {
    swigfaissJNI.ProductQuantizer_compute_codes(
        swigCPtr, this, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_unsigned_char.getCPtr(codes), n);
  }

  public void compute_codes_with_assign_index(
      SWIGTYPE_p_float x, SWIGTYPE_p_unsigned_char codes, long n) {
    swigfaissJNI.ProductQuantizer_compute_codes_with_assign_index(
        swigCPtr, this, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_unsigned_char.getCPtr(codes), n);
  }

  public void decode(SWIGTYPE_p_unsigned_char code, SWIGTYPE_p_float x) {
    swigfaissJNI.ProductQuantizer_decode__SWIG_0(
  ...
  public void decode(SWIGTYPE_p_unsigned_char code, SWIGTYPE_p_float x, long n) {
    swigfaissJNI.ProductQuantizer_decode__SWIG_1(
        swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(code), SWIGTYPE_p_float.getCPtr(x), n);
  }

  public void compute_code_from_distance_table(
      SWIGTYPE_p_float tab, SWIGTYPE_p_unsigned_char code) {
    swigfaissJNI.ProductQuantizer_compute_code_from_distance_table(
        swigCPtr, this, SWIGTYPE_p_float.getCPtr(tab), SWIGTYPE_p_unsigned_char.getCPtr(code));
  }

  public void compute_distance_table(SWIGTYPE_p_float x, SWIGTYPE_p_float dis_table) {
    swigfaissJNI.ProductQuantizer_compute_distance_table(
        swigCPtr, this, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(dis_table));
  }

  public void compute_inner_prod_table(SWIGTYPE_p_float x, SWIGTYPE_p_float dis_table) {
    swigfaissJNI.ProductQuantizer_compute_inner_prod_table(
        swigCPtr, this, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(dis_table));
  }

  public void compute_distance_tables(long nx, SWIGTYPE_p_float x, SWIGTYPE_p_float dis_tables) {
    swigfaissJNI.ProductQuantizer_compute_distance_tables(
        swigCPtr, this, nx, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(dis_tables));
  }

  public void compute_inner_prod_tables(long nx, SWIGTYPE_p_float x, SWIGTYPE_p_float dis_tables) {
    swigfaissJNI.ProductQuantizer_compute_inner_prod_tables(
        swigCPtr, this, nx, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(dis_tables));
  }
  ...
  public void search(
      ...
      boolean init_finalize_heap) {
    swigfaissJNI.ProductQuantizer_search__SWIG_0(
        swigCPtr,
        this,
  ...
  public void search(
      ...
      long ncodes,
      float_maxheap_array_t res) {
    swigfaissJNI.ProductQuantizer_search__SWIG_1(
        swigCPtr,
        this,
        SWIGTYPE_p_float.getCPtr(x),
        nx,
  ...
  public void search_ip(
      ...
      boolean init_finalize_heap) {
    swigfaissJNI.ProductQuantizer_search_ip__SWIG_0(
        swigCPtr,
        this,
        SWIGTYPE_p_float.getCPtr(x),
        nx,
  ...
  public void search_ip(
      ...
      long ncodes,
      float_minheap_array_t res) {
    swigfaissJNI.ProductQuantizer_search_ip__SWIG_1(
        swigCPtr,
        this,
        SWIGTYPE_p_float.getCPtr(x),
        nx,
  ...
  public void search_sdc(
      SWIGTYPE_p_unsigned_char qcodes,
      long nq,
      SWIGTYPE_p_unsigned_char bcodes,
      long ncodes,
      float_maxheap_array_t res,
      boolean init_finalize_heap) {
    swigfaissJNI.ProductQuantizer_search_sdc__SWIG_0(
        swigCPtr,
        this,
        SWIGTYPE_p_unsigned_char.getCPtr(qcodes),
        nq,
        SWIGTYPE_p_unsigned_char.getCPtr(bcodes),
        ncodes,
        float_maxheap_array_t.getCPtr(res),
        res,
        init_finalize_heap);
  ...
  public void search_sdc(
      ...
      long ncodes,
      float_maxheap_array_t res) {
    swigfaissJNI.ProductQuantizer_search_sdc__SWIG_1(
        swigCPtr,
        this,
        SWIGTYPE_p_unsigned_char.getCPtr(qcodes),
        nq,
  ...
  public static class PQEncoderGeneric {
    private transient long swigCPtr;
    protected transient boolean swigCMemOwn;
    ...
    public void setCode(SWIGTYPE_p_unsigned_char value) {
      swigfaissJNI.ProductQuantizer_PQEncoderGeneric_code_set(
    ...
    public PQEncoderGeneric(SWIGTYPE_p_unsigned_char code, int nbits, short offset) {
      this(
          swigfaissJNI.new_ProductQuantizer_PQEncoderGeneric__SWIG_0(
              SWIGTYPE_p_unsigned_char.getCPtr(code), nbits, offset),
          true);
    }

    public PQEncoderGeneric(SWIGTYPE_p_unsigned_char code, int nbits) {
      this(
          swigfaissJNI.new_ProductQuantizer_PQEncoderGeneric__SWIG_1(
              SWIGTYPE_p_unsigned_char.getCPtr(code), nbits),
          true);
    }
  ...
  public static class PQEncoder8 {
    private transient long swigCPtr;
    protected transient boolean swigCMemOwn;
    ...
    public void setCode(SWIGTYPE_p_unsigned_char value) {
      swigfaissJNI.ProductQuantizer_PQEncoder8_code_set(
          swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(value));
    }
    ...
    public PQEncoder8(SWIGTYPE_p_unsigned_char code, int nbits) {
      this(
          swigfaissJNI.new_ProductQuantizer_PQEncoder8(
              SWIGTYPE_p_unsigned_char.getCPtr(code), nbits),
          true);
    }
  ...
  public static class PQEncoder16 {
    private transient long swigCPtr;
    protected transient boolean swigCMemOwn;
    ...
    public void setCode(SWIGTYPE_p_unsigned_short value) {
      swigfaissJNI.ProductQuantizer_PQEncoder16_code_set(
          swigCPtr, this, SWIGTYPE_p_unsigned_short.getCPtr(value));
    }
    ...
    public PQEncoder16(SWIGTYPE_p_unsigned_char code, int nbits) {
      this(
          swigfaissJNI.new_ProductQuantizer_PQEncoder16(
              SWIGTYPE_p_unsigned_char.getCPtr(code), nbits),
          true);
    }
  ...
  public static class PQDecoderGeneric {
    private transient long swigCPtr;
    protected transient boolean swigCMemOwn;
    ...
    public void setCode(SWIGTYPE_p_unsigned_char value) {
      swigfaissJNI.ProductQuantizer_PQDecoderGeneric_code_set(
          swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(value));
    }
    ...
    public PQDecoderGeneric(SWIGTYPE_p_unsigned_char code, int nbits) {
      this(
          swigfaissJNI.new_ProductQuantizer_PQDecoderGeneric(
              SWIGTYPE_p_unsigned_char.getCPtr(code), nbits),
          true);
    }
  ...
  public static class PQDecoder8 {
    private transient long swigCPtr;
    protected transient boolean swigCMemOwn;
    ...
    public void setCode(SWIGTYPE_p_unsigned_char value) {
      swigfaissJNI.ProductQuantizer_PQDecoder8_code_set(
          swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(value));
    }
    ...
    public PQDecoder8(SWIGTYPE_p_unsigned_char code, int nbits) {
      this(
          swigfaissJNI.new_ProductQuantizer_PQDecoder8(
              SWIGTYPE_p_unsigned_char.getCPtr(code), nbits),
          true);
    }
  ...
  public static class PQDecoder16 {
    private transient long swigCPtr;
    protected transient boolean swigCMemOwn;
    ...
    public void setCode(SWIGTYPE_p_unsigned_short value) {
      swigfaissJNI.ProductQuantizer_PQDecoder16_code_set(
          swigCPtr, this, SWIGTYPE_p_unsigned_short.getCPtr(value));
    }
    ...
    public PQDecoder16(SWIGTYPE_p_unsigned_char code, int nbits) {
      this(
          swigfaissJNI.new_ProductQuantizer_PQDecoder16(
              SWIGTYPE_p_unsigned_char.getCPtr(code), nbits),
          true);
    }
  ...
  public static final class train_type_t {
    ...
    public static train_type_t swigToEnum(int swigValue) {
      ...
      throw new IllegalArgumentException(
          "No enum " + train_type_t.class + " with value " + swigValue);
    }
    ...
    private static train_type_t[] swigValues = {
      Train_default, Train_hot_start, Train_shared, Train_hypercube, Train_hypercube_pca
    };
